function Fly(fid, type, color, sh, sw, x, y, fly_img, name) {
	...
	f.style.cursor = "url('https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/images/xit_muoi.png'), auto;";
	var parent = this;
...
$(document).ready(function() {
	...
	// alert(value);
		switch (value) { 
		case 1: 
			var fly = new Fly("test", "Nhặng", "Đen", height_fly, width_fly, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/flies.png", "Long ruồi");	
			break;
		case 2: 
			var fly = new Fly("test", "Nhặng", "Xanh", height_fly, width_fly, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/style_1.png", "King ruồi");
			break;
		case 3: 
			var fly = new Fly("test", "Nhặng", "Tuyệt sắc", height_fly, width_fly, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/style_2.png","Tom ruồi");
			break;		
		case 4: 
			var fly = new Fly("test", "Nhặng", "Hồng", height_fly, width_fly, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/tyle_3.png", "Queen ruồi");
			break;
		}
		fly.move();	

	if(var_2 == 'true'){
		var fly2 = new Fly("test", "Nhặng", "Xanh", height_fly, width_fly, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/style_1.png", "King ruồi");
		// var fly3 = new Fly("test", "Nhặng", "Tuyệt sắc", 0, 0, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/","Tom ruồi");
		// var fly4 = new Fly("test", "Nhặng", "Hồng", 0, 0, 0, 0, "https://raw.githubusercontent.com/tuboyocdo/popup/refs/heads/main/ruoibay_file/style_3.png", "Queen ruồi");
		fly2.move();
		fly2.flying();
		// fly3.move();
		// fly4.move();
